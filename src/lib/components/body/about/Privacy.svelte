<section>
	<div class="policy-container">
		<h2>Privacy Policy of Robo's Kindle Clipping</h2>

		<p>
			Robo's Kindle Clipping operates the https://robos-kindle-clipping-frontend.vercel.app website,
			which provides the SERVICE.
		</p>

		<p>
			This page is used to inform website visitors regarding our policies with the collection, use,
			and disclosure of Personal Information if anyone decided to use our Service, the Robo's Kindle
			Clipping website.
		</p>
		...
		<p>
			...
			described in this Privacy Policy. Our Privacy Policy was created with the help of the <a
				href="https://www.privacypolicytemplate.net">Privacy Policy Template Generator</a
			>.
		</p>

		<p>
			The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
			which is accessible at https://robos-kindle-clipping-frontend.vercel.app, unless otherwise
